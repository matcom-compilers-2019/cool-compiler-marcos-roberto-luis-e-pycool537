...
li $t1, 0
lw $a0, 4($a1)
loop15615207119495451:
lw $t2, ($a1)
beq $t1, $a0, brake1561520711949653
sw $t2,($t0)
add $a1, $a1, 4
add $t0, $t0, 4
add $t1, $t1, 1
j loop15615207119495451
brake1561520711949653:
sw $v0, -16($fp)
lw $v0, -16($fp)
move $sp, $fp
subu $a0, $sp, 4
...
li $t1, 0
lw $a0, 4($a1)
loop1561520711949823:
lw $t2, ($a1)
beq $t1, $a0, brake1561520711949902
sw $t2,($t0)
add $a1, $a1, 4
add $t0, $t0, 4
add $t1, $t1, 1
j loop1561520711949823
brake1561520711949902:
sw $v0, -16($fp)
lw $v0, -16($fp)
move $sp, $fp
subu $a0, $sp, 4
...
lw $a1, -16($fp)
li $a0, 0
lengthLoop15615207119501839:
lb $t2, ($a1)
beq $t2, $zero, brakeLengthLoop15615207119502614
add $a0, $a0, 1
add $a1, $a1, 1
j lengthLoop15615207119501839
brakeLengthLoop15615207119502614:
sw $a0, -12($fp)
lw $v0, -12($fp)
move $sp, $fp
subu $a0, $sp, 4
...
lw $a1, -24($fp)
li $a0, 0
lengthLoop15615207119504192:
lb $t2, ($a1)
beq $t2, $zero, brakeLengthLoop15615207119504955
add $a0, $a0, 1
add $a1, $a1, 1
j lengthLoop15615207119504192
brakeLengthLoop15615207119504955:
sw $a0, -28($fp)
lw $a1, -16($fp)
li $a0, 0
lengthLoop15615207119505887:
lb $t2, ($a1)
beq $t2, $zero, brakeLengthLoop15615207119506655
add $a0, $a0, 1
add $a1, $a1, 1
j lengthLoop15615207119505887
brakeLengthLoop15615207119506655:
sw $a0, -20($fp)
lw $a1, -24($fp)
lw $a0, -28($fp)
lw $t0, -20($fp)
...
syscall
move $t0, $v0
loop15615207119507806:
lb $t2, ($a1)
beq $t2, $zero, brake1561520711950857
sb $t2,($t0)
add $a1, $a1, 1
add $t0, $t0, 1
j loop15615207119507806
brake1561520711950857:
lw $a1, -16($fp)
loop215615207119509368:
lb $t2, ($a1)
beq $t2, $zero, brake215615207119510205
sb $t2,($t0)
add $a1, $a1, 1
add $t0, $t0, 1
j loop215615207119509368
brake215615207119510205:
sb $zero, ($t0)
sw $v0, -12($fp)
li $a0, 16
li $v0, 9
...
move $t0, $v0
li $t1, 0
loop15615207119512353:
lb $t2, ($a1)
beq $t2, $zero, brake1561520711951312
beq $t1, $a0, brake1561520711951312
sb $t2,($t0)
add $a1, $a1, 1
add $t1, $t1, 1
add $t0, $t0, 1
j loop15615207119512353
brake1561520711951312:
sb $zero, ($t0)
sw $v0, -12($fp)
lw $v0, -12($fp)
move $sp, $fp
