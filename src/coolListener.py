# Generated from cool.g by ANTLR 4.7.1
from antlr4 import *
...
class coolListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by coolParser#start.
    def enterStart(self, ctx:coolParser.StartContext):
        pass

    # Exit a parse tree produced by coolParser#start.
    def exitStart(self, ctx:coolParser.StartContext):
        pass
